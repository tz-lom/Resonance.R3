          ...
          case File_DataBlock::ID:
          {
            ...
            switch(data.id())
            {
              case Float64::ID:
              {
                ...
                RObject db = DB_channels(types[stream], (double)data.extractField<Float64::created>()/TIME_SCALING_FACTOR, raw);
                
                db.attr("created") = (double)data.extractField<Float64::created>()/TIME_SCALING_FACTOR;
                db.attr("received") = (double)data.extractField<Float64::received>()/TIME_SCALING_FACTOR;
              ...
              case Resonance::R3::Int32::ID:
              {
                ...
                RObject db = DB_channels(types[stream], (double)data.extractField<Resonance::R3::Int32::created>()/TIME_SCALING_FACTOR, raw);
                
                db.attr("created") = (double)data.extractField<Resonance::R3::Int32::created>()/TIME_SCALING_FACTOR;
                db.attr("received") = (double)data.extractField<Resonance::R3::Int32::received>()/TIME_SCALING_FACTOR;
